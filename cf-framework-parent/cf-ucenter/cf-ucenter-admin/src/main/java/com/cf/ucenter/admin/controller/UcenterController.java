        ...
        for (int page = 1; page <= totalPages; page++) {
            ...
            if (pageData != null) {
                for (CfUser cfUser : pageData) {
                    ...
                    dataRow.createCell(1).setCellValue(cfUser.getId());
                    dataRow.createCell(2).setCellValue(cfUser.getUserName());
                    dataRow.createCell(3).setCellValue(cfUser.getNickName());
                    dataRow.createCell(4).setCellValue(cfUser.getTrueName());
                    dataRow.createCell(5).setCellValue(cfUser.getPhone());
                    dataRow.createCell(6).setCellValue(cfUser.getSex() == null ? "" : cfUser.getSex() == 1 ? "男" : cfUser.getSex() == 2 ? "女" : "保密");
                    dataRow.createCell(7).setCellValue(cfUser.getType() == null ? "" : cfUser.getType() == 1 ? "管理员" : "普通用户");
